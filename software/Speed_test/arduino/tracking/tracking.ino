...
void loop() {
  ...
  while ( network.available() ) {
    ...
    SerialUSB.print(cmd[0]); SerialUSB.print(" ");
    SerialUSB.print(cmd[1]); SerialUSB.print(" ");
    SerialUSB.print(cmd[2]); SerialUSB.print(" ");
    SerialUSB.print(cmd[3]); SerialUSB.print(" ");
    SerialUSB.print(cmd[4]); SerialUSB.print(" ");
    SerialUSB.print(cmd[5]); SerialUSB.print(" ");
    SerialUSB.print(cmd[6]); SerialUSB.print(" ");
...
//    if (ii < cali_data_len) {
    ...
    if (cali_done_flag == 1 && cmd_flag == 1) {
      ...
      //  ====================================================================================
//      if (encoder1Counter < 40) turnonmotor();
//      else turnoffmotor();

      if (encoder1Counter <= 14) turnonmotor();
      
      if (encoder1Counter > 14 && encoder1Counter <= 58){
        if (gyroZangle > -90){
          turnright(-90);
        }
        else{
      ...
      else if (encoder1Counter > 58 && encoder1Counter <= 60) turnonmotor();
      
      else if (encoder1Counter > 60 && encoder1Counter <= 91){
        if (gyroZangle < 0){
          turnleft(0);
        }
        else{
      ...
      else if (encoder1Counter > 91 && encoder1Counter <= 114){
        if (gyroZangle < 45){
          turnleft(45);
        }
        else{
      ...
      else if (encoder1Counter > 114 && encoder1Counter <= 136){
        if (gyroZangle > 0){
          turnright(0);
        }
        else{
      ...
      else if (encoder1Counter > 136 && encoder1Counter <= 144){
        turnonmotor();
      }

      else if (encoder1Counter > 134) turnoffmotor();
      ...
      if (dev_encoder1Counter < 0) dev_encoder1Counter += 255;
...
void turnleft(int degree) {   /// Turn left
  analogWrite(M1_PWM, 70+abs(degree - gyroZangle));
  analogWrite(M2_PWM, 0);
}

void turnright(int degree) {   /// Turn right
  analogWrite(M1_PWM, 0);
  analogWrite(M2_PWM, 70+abs(degree - gyroZangle));
}
